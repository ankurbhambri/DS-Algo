...
# Idea: Start from the bottom-left corner of the matrix and move right column wise when value if greater or up to decrease the row in case of target is smaller.
