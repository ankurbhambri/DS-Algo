...
This is a variation of the sliding window problem where we need to find the longest substring that can be assigned to the last,
friend after distributing at least one character to each friend.
