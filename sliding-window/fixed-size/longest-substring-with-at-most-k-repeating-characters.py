...
print(longestSubstring("aaabb", 3))  # Output: 3 ("aaa")
print(longestSubstring("ababbc", 2))  # Output: 5 ("ababb")
print(longestSubstring("aabbcc", 1))  # Output: 2 ("aa" or "bb" or "cc")
print(longestSubstring("abcde", 1))  # Output: 1 ("a" or "b" or "c" or "d" or "e")
print(longestSubstring("aabbcc", 2))  # Output: 6 ("aabbcc")
print(longestSubstring("aabbccdd", 3))  # Output: 8 ("aabbccdd")
