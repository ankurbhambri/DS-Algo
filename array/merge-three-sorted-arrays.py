...
5 mins: Questions to the interviewer - Clarification on Input and Output: [Are the input arrays allowed to be modified during the process?, Should the final result array be sorted as well?]
